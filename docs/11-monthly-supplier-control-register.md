...
| Ongoing | Digital Mobility Solutions Lanka / PickMe | Actual-usage prepayment | Ongoing | Pull current top-ups and available supplier prepayment from Xero | Actual supported monthly usage | 430 | Do not create equal recurring bills; identify the exact available Xero prepayment object before applying it to usage bills. |
