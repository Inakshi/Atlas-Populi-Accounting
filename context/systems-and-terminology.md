...
| Jira | Payment requests, supporting information, approvals and task coordination in the existing AP workflow. The agreed agent operating model also places task progress and follow-up here. | An issue's status is not, by itself, proof that a bank payment occurred or an accounting record was saved. Detailed task conventions belong in SOPs and skills. |
